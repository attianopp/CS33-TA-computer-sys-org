 ...
 */
  ...
  int iScale, jScale;
	...
	//ADD CHECKS FOR RETURN VALUES, HISTO OUTPUT, AND ARRAY/DATA MANIPULATION
  ...
  printf("\n\nATTENTION: There were %d errors in the fib check\n", numWrong);
  //numWrong = 0;
  ...
  if(totalWrong != 0){
	//could give correctness score based on number of errors here or based on each testing section above
